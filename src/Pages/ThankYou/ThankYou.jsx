...
const ThankYou = () => {
  return (
    <div className='bg-primary flex items-center justify-center h-screen text-[2rem] flex-col tracking-[0.1rem] px-4 md:px-0  space-y-3'>
        ...
        <h1 className='text-secondary text-[2.5rem]  font-M_bold text-center leading-[2.7rem]'>Thank You!
            <br/>
your message is in.
        </h1>
        <p className=' text-[1.5rem] leading-[2.5rem] font-R_regular text-background  '>
            We’ve got your submission. We’ll swirl it, bold <br/> it, and get back to you within 48–72 hours.
        </p>
        ...
        <p className='font-M_bold text-[.7rem]'>
