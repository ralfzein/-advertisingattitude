      ...
      <form ref={formRef} onSubmit={handleSend}>
        ...
        <div className="flex flex-col justify-center items-center gap-8 mt-10">
          ...
          <div className="flex items-center justify-start w-full gap-5">
            <label htmlFor="email" className="font-M_medium w-[8rem]  text-[1.5rem] text-primary cursor-pointer">Email</label>
          ...
          {/* Name */}
          <div className="flex items-center justify-start w-full gap-5">
            <label htmlFor="name" className="font-M_medium w-[8rem]  cursor-pointer text-[1.5rem] text-primary">Name</label>
          ...
          {/* Country */}
          <div className="flex items-center justify-start w-full gap-5">
            <label htmlFor="country" className="font-M_medium w-[8rem]  text-[1.5rem] text-primary">Country</label>
            <input id="country" name="country" className="border-b  border-primary/10 caret-secondary focus:outline-none font-M_medium w-full text-primary text-[1.4rem]" />
          </div>
