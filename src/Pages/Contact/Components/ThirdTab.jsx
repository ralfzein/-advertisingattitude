    ...
    >
      ...
      >
        ✕
            ...
            justify-center flex-1 md:flex-none mt-6 md:mt-0 w-auto md:w-[28rem] py-3 md:py-0 h-[3rem] md:h-[5rem] hover:bg-secondary hover:opacity-80 cursor-pointer rounded-full
             "
                >
