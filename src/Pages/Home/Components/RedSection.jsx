...
and campaign execution.
     ...
     > evolve, and lead.
        ...
        <motion.h1  variants={childVariants} className= 'hidden text-primary text-center md:text-left md:inline-block tracking-[.2rem]  md:tracking-[.15rem] font-R_regular text-[2rem] md:text-[3.6rem] leading-[1rem] md:leading-[1.3]  -ml-[5px] pl-0  font-normal     uppercase'
     > We help growth-stage businesses create,
        </motion.h1>
        <motion.h1  variants={childVariants} className= 'hidden text-primary text-center md:text-left md:inline-block tracking-[.2rem]  md:tracking-[.15rem] font-R_regular text-[2rem] md:text-[3.6rem] leading-[1rem] md:leading-[1.3]  -ml-[5px] pl-0  font-normal     uppercase'
