...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        R_regular: ["R_regular", "sans-serif"],
        M_regular: ["M_regular", "sans-serif"],
        M_medium: ["M_medium", "sans-serif"],
        M_bold: ["M_bold", "sans-serif"],
        M_semibold: ["M_semibold", "sans-serif"],
        M_extrabold: ["M_extrabold", "sans-serif"],
      },
    },
  },
